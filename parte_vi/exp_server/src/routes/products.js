...
const authMiddleware = require("../middleware/auth/auth"); // Importar o middleware de autenticação (Função intermediária para verfiicar sempre que houver pedido para a rota)
...
productsRouter.post("/", controller.create); // Rota para criar um novo produto (Necessário estar autenticado)
productsRouter.put("/:id", authMiddleware, controller.update); // Rota para atualizar um produto pelo id (Necessário estar autenticado)
